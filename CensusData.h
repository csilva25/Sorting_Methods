...
//
   void m_insertionSort(int,vector<Record*> &);
   void m_mergeSort(int, int, int, vector <Record*> &);
   void merge(int, int, int, int, vector <Record*> &);
   
   void m_quickSort(int, int, int, vector <Record*> &);
   int partition(int, int, int, vector <Record*> &);
   int randomized_partition(int, int, int, vector <Record*> &);
